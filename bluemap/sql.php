...
// These are read from environment variables (e.g. set them in Coolify's
// "Environment Variables" tab). Fallback defaults are used if a variable
// is not set, so this also still works for plain local testing.

$driver   = getenv('BLUEMAP_DB_DRIVER')   ?: 'mysql'; // 'mysql' or 'pgsql'
