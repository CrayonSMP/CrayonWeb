...
const ChangelogCreator = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(
        "Changelog erfolgreich in Firestore gespeichert und veröffentlicht!"
      );
      setFormData({
        title: "",
        description: "",
  ...
  const InputStyle =
    "w-full p-3 rounded bg-gray-700 text-white border border-gray-600 focus:border-[#ff0040] focus:ring focus:ring-[#ff0040] focus:ring-opacity-50 transition";
      ...
      <div className="max-w-3xl mx-auto px-4 w-full">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold text-white flex items-center">
            <PlusCircle className="w-8 h-8 mr-3 text-[#ff0040]" /> Changelog
            Creator
          </h1>
          <button
        ...
        <div className="section-card p-8" data-aos="fade-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="details" className={LabelStyle}>
                Details / Bullet Points (Zeilenumbruch für neue Punkte)
              </label>
              <textarea
                id="details"
                name="details"
            ...
            <button
              type="submit"
              className="cta-button primary w-full flex items-center justify-center"
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <MessageCircle className="w-5 h-5 mr-2" /> Changelog erstellen
                  &amp; veröffentlichen
                </>
              )}
            </button>
